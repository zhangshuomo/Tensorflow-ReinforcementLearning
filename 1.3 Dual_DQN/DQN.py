...
class DeepQnetwork(object):
	def __init__(self,n_features,n_actions,learning_rate=0.001,discount_factor=0.9,epsilon=0.9,
			memory_space=500,batch_size=32,steps_update=200,epsilon_increment=False):
